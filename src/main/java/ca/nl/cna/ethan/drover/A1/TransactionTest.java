...
public class TransactionTest {
    ...
    public static void main(String[] args) {
        ...
        // Starting Balance
        System.out.printf("\nStarting Savings Balance: %f",ethanSavings.getBalance());
        System.out.printf("\nSarting Chequing Balance: %f",droverChequing.getBalance());
        System.out.println("");

        // Deposit 5000
        ethanSavings.deposit(5000);
        System.out.printf("\nDeposited 5000 into Savings Account \nNew Savings Balance: %f",ethanSavings.getBalance());

        // Adding interest
        System.out.println("");
        System.out.println("\nAdding Interest 3% to Savings Account");
        ethanSavings.addInterest(ethanSavings.getInterestRate());
        System.out.printf("New Savings Balance: %f",ethanSavings.getBalance());

        // Transferring $1000 into Chequing Account
        System.out.println("");
        System.out.println("\nTransfer $1000 To the Chequing Account from Savings Account");
        BankAccount.transfer(droverChequing,ethanSavings,1000);
        System.out.printf("New Chequing Balance: %f",droverChequing.getBalance());
        ...
        System.out.println("");
        System.out.printf("Final Savings Balance: %f",ethanSavings.getBalance());
        System.out.println("");
        System.out.printf("Final Chequing Balance: %f",droverChequing.getBalance());
        }
    }