...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            System.out.println("5. Sort by Course Credits");
            System.out.println("6. Sort by Last Name");
            System.out.println("7. Show Students with Balance Owing");
            ...
            if (choice.equals("1")) {
                ...
                List<Student> filtered = studentManager.filterWithBalance(students);
                StudentUI.printStudents(filtered);

                System.out.print("Enter filename to save students with balance owing: ");
                String filteredFile = scanner.nextLine();
                StudentFileManager filteredManager = new StudentFileManager(filteredFile);

                if (filteredManager.saveStudents(new ArrayList<>(filtered))) {
                    System.out.println("Filtered list saved to " + filteredFile);
                } else {
                    System.out.println("Failed to save filtered list.");
                }
            }
